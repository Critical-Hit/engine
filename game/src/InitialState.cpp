...
void InitialState::Initialize(std::shared_ptr<GameStateManager> manager)
{
    ...
    this->graphicsManager->RegisterSprite(std::make_shared<Sprite>(-0.5, 0.5f, 0.5f, 0.5f));
    this->graphicsManager->RegisterSprite(std::make_shared<Sprite>( 0.0, 0.5f, 0.5f, 0.5f));
    this->graphicsManager->RegisterSprite(std::make_shared<Sprite>(-0.5, 0.0f, 0.5f, 0.5f));
    this->graphicsManager->RegisterSprite(std::make_shared<Sprite>(0.0, 0.0f, 0.5f, 0.5f));
